...
public abstract class Atraccion implements Serializable {
    ...
    public void registrarIngresoVisitante() {
        if (this.estado == EstadoAtraccion.ACTIVA) {
            ...
            if (requiereMantenimiento()) {
                actualizarEstado(EstadoAtraccion.EN_MANTENIMIENTO, "Límite de 500 visitantes alcanzado.");
            }
        }
    }
    ...
    public int getCapacidadMaximaCiclo() { return capacidadMaximaCiclo; }
    public void setCapacidadMaximaCiclo(int capacidadMaximaCiclo) { this.capacidadMaximaCiclo = capacidadMaximaCiclo; }
    ...
    public int getContadorUso() { return contadorVisitantesAcumulado; }
    public int getTiempoEsperaEstimado() { return colaVirtual != null ? colaVirtual.getTiempoEstimado() : tiempoEsperaEstimado; }
    ...
    public boolean isAltoRiesgo() { return altoRiesgo; }
    public void setAltoRiesgo(boolean altoRiesgo) { this.altoRiesgo = altoRiesgo; }
    public ColaVirtual getColaVirtual() { return colaVirtual; }

    @Override
    public String toString() {
        return "Atraccion{" + "idUnico='" + idUnico + '\'' + ", nombre='" + nombre + '\'' + ", estado=" + estado + '}';
    }
}